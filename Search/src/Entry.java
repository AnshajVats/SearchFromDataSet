...
public enum Entry {
    ...
    BOOK_VERB3("Book", "verb", "To arrange for something on a particular date."),
    BOOK_VERB4("Book", "verb", "To arrange for something on a particular date."),
...
// Placeholder Section
    ...
    PLACEHOLDER_CONJUNCTION("Placeholder", "connjunction", "To Be Updated..."),
    ...
    // Enum constructor
    Entry(String word, String partOfSpeech, String definition) {
        this.word = word;
    ...
    public int compareEntries(Entry other) {
        int keywordComparison = this.word.compareToIgnoreCase(other.word);
        if (keywordComparison != 0) {
            return keywordComparison;
        }
        return this.partOfSpeech.compareToIgnoreCase(other.partOfSpeech);
    }
}